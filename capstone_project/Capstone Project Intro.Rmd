...
im.convert("capital_report_master_card_embed.pdf", output = "capital_report_master_card_embed.png", extra.opts="-density 600")
...
```{r}
pdf("city_benchmark_availability_30.pdf", width=8,height=8)
...
# Embed the fonts
embed_fonts("city_benchmark_availability_30.pdf", outfile="city_benchmark_availability_30_embed.pdf")
im.convert("city_benchmark_availability_30_embed.pdf", output = "city_benchmark_availability_30_embed.png", extra.opts="-density 600")
```
...
im.convert("city_benchmark_price_embed.pdf", output = "city_benchmark_price_embed.png", extra.opts="-density 600")
```
## Group by room_type
...
im.convert("city_benchmark_room_type_embed.pdf", output = "city_benchmark_room_type_embed.png", extra.opts="-density 600")
```
