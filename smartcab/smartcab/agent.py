...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.trial_count += 1
            self.epsilon = math.pow(self.decaying_const, self.trial_count)
        return None
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if self.epsilon - random.random() > 0:
                action = random.choice(self.valid_actions)
            else:
                valid_actions = []
    ...
    def learn(self, state, action, reward):
        ...
        ## TO DO ##
        ###########
        # When learning, implement the i iteration update rule
